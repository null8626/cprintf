...
#define CPRINTF_DESCRIPTION "Portable C/C++ Library for printing colored text on the terminal with the C formatting style."
#define CPRINTF_TYPE VFT_DLL
#define CPRINTF_ORIGINAL_FILENAME "cprintf.dll"
