...
#define cprintf_out(text)             WriteConsoleA(_cprintf_handle, text, strlen(text), NULL, NULL)
...
#define cprintf_color(code)           write(1, "\x1b[" code "10m", sizeof("\x1b[" code "10"))
#define cprintf_out(text)             fputs(text, stdout)
